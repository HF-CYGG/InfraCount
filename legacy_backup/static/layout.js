...
function _isGlobalStylesheetHref(href) {
    ...
    const h = String(href);
    return h.includes('/legacy/static/style.css') || h.includes('/legacy/static/lib/fontawesome') || h.includes('/legacy/static/fonts/') || h.includes('/static/style.css') || h.includes('/static/lib/fontawesome') || h.includes('/static/fonts/');
}

function _isGlobalScriptSrc(src) {
    if (!src) return false;
    const s = String(src);
    return s.includes('/legacy/static/layout.js') || s.includes('/static/layout.js');
}
